/*
	...
	COMPLETE -	The erase operation will remove the phone book entry with the associated name from the collection.
	...
	COMPLETE -	The find member function will determine if there is a phoneBookEntrywith the specified name in the collection. It will return true if it is found and false if it is not found.

	COMPLETE -	The two print functions will print out the contents of the phoneBook. One will output to cout and the other will output to the passed in ostream object (passed by reference).
	...
	COMPLETE -	You should also have a debug member function. It should output the contents of the vector. You can output any additional information you would find helpful in debugging.

	COMPLETE -	The size member function will return the currently number of entries in the phoneBook.
